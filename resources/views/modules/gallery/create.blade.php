@extends('layouts.app')
@section('title','Gallery | Add | LimitlessCMS')
@section('breadcrumb')
   <div class="content-header row">
      <div class="content-header-left col-md-6 col-12 mb-1 breadcrumb-new">
         <h3 class="content-header-title mb-0 d-inline-block"><i class="fal fa-photo-video"></i> Add Gallery</h3>
            ...
            <div class="card-body">
               {!! Form::open(array('route' => 'gallery.store','enctype'=>'multipart/form-data')) !!}
                  ...
                  <div class="form-group form-group-default required">
                     ...
                     {!! Form::file('cover_image',array('class' => 'form-control', 'id' => 'thumbnail', 'files'=> true,'required' => '')) !!}
                  </div>
                  ...
                  <div class="form-group">
                     <center>
                        <button type="submit" class="btn btn-success submit"><i class="fal fa-save"></i> Create Gallery</button>
