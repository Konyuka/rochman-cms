...
@section('content')
   <div id="content" class="content"> 
      ...
      <ol class="breadcrumb pull-right">
         ...
         <li class="breadcrumb-item active">All Posts Type</li>
      </ol>
      <!-- end breadcrumb -->
      <h1 class="page-header">All Posts Type</h1>
         ...
         <div class="col-md-6">
            <div class="panel panel-inverse">
               <div class="panel-heading">
                  ...
                  <h4 class="panel-title">Post Type Details</h4>
               </div>
               <div class="panel-body">
                  {!! Form::open(array('route' => 'post.type.store','enctype'=>'multipart/form-data','data-parsley-validate' => '','method'=>'post')) !!}
                  ...
                  <center>{!! Form::submit('Create Type',array('class' =>'btn btn-success')) !!}</center>
                  {!! Form::close() !!}
               </div>
            </div>
         </div>
