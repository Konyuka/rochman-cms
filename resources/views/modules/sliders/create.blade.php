@extends('layouts.app')
@section('title','Create Slider | LimitlessCMS')
@section('breadcrumb')
...
<div class="card">
   <div class="card-body">
      {!! Form::open(array('route' => 'slider.store','enctype'=>'multipart/form-data')) !!}
         <div class="row">
            <div class="col-md-6">
               <!-- Text inputs -->
            ...
            <div class="col-md-6">
               ...
               <div class="panel-body">
                  ...
                  <div class="form-group">
                     <center>
                        {!! Form::submit('Create Slider',array('class' =>'btn btn-success submit')) !!}
