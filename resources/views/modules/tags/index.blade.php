@extends('layouts.app')
{{-- page header --}}
@section('title','Post | Tags | LimitlessERP')
@section('breadcrumb')
...
@section('content')
   ...
   <div class="row">         
      ...
      <div class="col-md-6">
         {!! Form::open(array('route' => 'post.tags.store','enctype'=>'multipart/form-data','data-parsley-validate' => '')) !!}
            <div class="card">
               <div class="card-body">
                  <h4>Post Tags Details</h4>
                  <hr>
                  ...
                  <div class="form-group">
                     <center>
                        <button type="submit" class="btn btn-success btn-sm submit"><i class="fal fa-save"></i> Save tag</button>
