@extends('layouts.app')
@section('title','Category | Create | LimitlessCMS')
@section('breadcrumb')
...
<div class="card">  
   <div class="card-body">  
      {!! Form::open(array('route' => 'post.category.store','enctype'=>'multipart/form-data','method' => 'post')) !!}
         @csrf()
         <div class="row">
            <div class="col-md-6">
               <div class="element-box">
                  <div class="panel-body">
                     ...
                     <div class="form-group form-group-default">
                        ...
                        {{ Form::select('parent',$parents, null, ['class' => 'form-control multiselect']) }}
                     </div>
                     <div class="form-group form-group-default">
               ...
               <div class="element-box">
                  <div class="panel-body">
                     <div class="form-group">
                        ...
                        {!! Form::textarea('description',null,['class'=>'form-control ckeditor','size' => '8x8', 'placeholder'=>'content']) !!}
                     </div>
                     <center>
